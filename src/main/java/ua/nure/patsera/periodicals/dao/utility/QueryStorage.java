...
public class QueryStorage {
        ...
        public static final String READ_ALL_PERIODICALS_DTO = "SELECT CATEGORY.NAME, PERIODICALS.NAME, PERIODICALS.PRICE, PERIODICALS.PHOTO, SUBSCRIPTION.IDPERIODICAL, COUNT(*) FROM SUBSCRIPTION\n" +
                "RIGHT JOIN PERIODICALS ON SUBSCRIPTION.IDPERIODICAL = PERIODICALS.ID INNER JOIN CATEGORY  ON PERIODICALS.IDCATEGORY=CATEGORY.ID GROUP BY IDPERIODICAL";
        ...
        public static final String READ_SORT_PRICE_ASC_PERIODICALS = "SELECT CATEGORY.NAME, P.NAME, P.PRICE, P.PHOTO, P.ID FROM PERIODICALS AS P INNER JOIN CATEGORY  ON P.IDCATEGORY=CATEGORY.ID  ORDER BY P.PRICE ASC";
        public static final String READ_SORT_PRICE_DESC_PERIODICALS = "SELECT CATEGORY.NAME, P.NAME, P.PRICE, P.PHOTO, P.ID FROM PERIODICALS AS P INNER JOIN CATEGORY  ON P.IDCATEGORY=CATEGORY.ID  ORDER BY P.PRICE DESC";
        public static final String READ_SORT_NAME_ASC_PERIODICALS = "SELECT CATEGORY.NAME, P.NAME, P.PRICE, P.PHOTO, P.ID FROM PERIODICALS AS P INNER JOIN CATEGORY  ON P.IDCATEGORY=CATEGORY.ID  ORDER BY P.NAME ASC";
        public static final String READ_SORT_NAME_DESC_PERIODICALS = "SELECT CATEGORY.NAME, P.NAME, P.PRICE, P.PHOTO, P.ID FROM PERIODICALS AS P INNER JOIN CATEGORY  ON P.IDCATEGORY=CATEGORY.ID  ORDER BY P.NAME DESC";
        public static final String READ_ALL_PERIODICAL_BY_NAME = "SELECT CATEGORY.NAME, P.NAME, P.PRICE, P.PHOTO, P.ID FROM PERIODICALS AS P INNER JOIN CATEGORY  ON P.IDCATEGORY=CATEGORY.ID WHERE P.NAME LIKE ?";
